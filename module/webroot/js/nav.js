const CasNav = {
  ...
  PAGES: [
    ...
    },
    {
      id: 'certs',
      label: '证书',
      icon: `<svg class="dock-svg" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M6.5 3.75h11A2.75 2.75 0 0 1 20.25 6.5v11a2.75 2.75 0 0 1-2.75 2.75h-11A2.75 2.75 0 0 1 3.75 17.5v-11A2.75 2.75 0 0 1 6.5 3.75Zm0 1.5c-.69 0-1.25.56-1.25 1.25v11c0 .69.56 1.25 1.25 1.25h11c.69 0 1.25-.56 1.25-1.25v-11c0-.69-.56-1.25-1.25-1.25h-11Zm2.75 3h5.5a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1 0-1.5Zm0 3.5h5.5a.75.75 0 0 1 0 1.5h-5.5a.75.75 0 0 1 0-1.5Zm0 3.5h3.25a.75.75 0 0 1 0 1.5H9.25a.75.75 0 0 1 0-1.5Z"/></svg>`
    },
    {
      id: 'log',
      label: '日志',
  ...
  setPage(id) {
    ...
    if (page === 'log') {
      ...
      if (typeof CasApp !== 'undefined') CasApp.refreshLog(false);
    }
